...
未撮影: なし（12 枚そろい・2026-08-29）。hortus はスマホ幅 1290x2796 を 16:10 に端末風合成（scratchpad compose_phone.py）（app-control はダミー PAT を localStorage 'control.pat' に入れて headless で撮影済）
